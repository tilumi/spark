...
object CodegenMetrics extends Source {
  ...
  def ITERATION_TOTAL_TIME: Histogram =
    metricRegistry.histogram(MetricRegistry.name("iterationTotalTime"))
  ...
  def refresh(): Any = {
    metricRegistry.remove(MetricRegistry.name("generatedClassSize"))
  }
